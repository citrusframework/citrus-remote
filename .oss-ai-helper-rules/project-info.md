...
- **Remote pattern:** `citrusframework/citrus-remote`
- **GitHub repo:** `citrusframework/citrus-remote`
- **Issue tracker:** GitHub
- **Issue tracker URL:** `https://github.com/citrusframework/citrus-remote/issues`
- **Issue ID format:** numeric
- **SonarCloud component key:** _(none)_
- **Documentation URL:** https://citrusframework.org/citrus/reference/html/
